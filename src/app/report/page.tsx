        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8" id="report-content">
          ...
          <div className="text-center border-b pb-8 mb-8">
            ...
            <div className="mt-6 text-sm text-gray-500 space-y-1">
              <div>작성일: {today}</div>
              <div>최종 원고 전달: 2026년 7월 3일</div>
              <div>성과공유회 배포: 2026년 7월 23일</div>
            ...
            <table className="w-full text-sm border-collapse">
              <tbody>
                {[
                  ...
                  ['규격', 'A4 · 컬러 · 50부 · 약 63페이지'],
                  ['제작 기간', '2026년 5월 ~ 7월'],
                  ['최종 원고 전달', '2026년 7월 3일'],
                  ['인쇄 의뢰', '2026년 7월 14일'],
                  ['성과공유회 배포', '2026년 7월 23일'],
            ...
            <table className="w-full text-sm border-collapse">
              ...
              <tbody>
                {[
                  ...
                  ['2주차', '5/26~5/30', '원고 집필 1라운드', '완료'],
                  ['3주차', '6/2~6/6', '원고 집필 2라운드', '완료'],
                  ['4주차', '6/9~6/13', '원고 1차 수합', '완료'],
                  ['5주차', '6/17~6/20', '가이드 배포 + 팀원 재작성', '완료'],
                  ['6주차', '6/23~6/27', '팀원 원고 제출·수합 — 6/23 김연수·이현직, 6/24 김정현, 6/27 이승원', '진행 중'],
                  ['7주차', '6/30~7/4', '7/1 이진규 파트 제출, 7/3 기획사 최종 원고 전달', '예정'],
                  ['8주차', '7/7~7/11', '기획사 디자인 검토 + 퇴고·수정', '예정'],
                  ['9주차', '7/14~7/18', '7/14 인쇄 의뢰 + 최종 확정', '예정'],
                  ['납품·행사', '7/22~7/23', '7/22 책 수령, 7/23 성과공유회 배포', '예정'],
                ].map(([w, d, task, status]) => (
            ...
            <table className="w-full text-sm border-collapse">
              ...
              <tbody>
                {[
                  ...
                  ['인쇄·제본', '1,300,000~1,500,000원', 'A4 컬러 약 63p, 50부 (견적 확인 후 확정)'],
                  ['예비비', '100,000~200,000원', '수정 인쇄 등'],
                  ['합계', '약 2,000,000원', ''],
                ].map(([item, amount, note], i) => (
                  <tr key={i} className={i === 4 ? 'bg-gray-50' : 'bg-white'}>
                    <td className={`border border-gray-200 px-3 py-2 ${i === 4 ? 'font-bold' : ''}`}>{item}</td>
                    <td className={`border border-gray-200 px-3 py-2 text-center ${i === 4 ? 'font-bold' : ''}`}>{amount}</td>
