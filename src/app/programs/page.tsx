...
const lifeCouponSessionChecks = [
  ...
  },
  {
    ...
    status: '내용확인',
    note: '2026.5.28.~29. 사업안내, 티타임, 집단·1:1 병행 방식으로 10명 참여가 확인됩니다. 감정·가치카드는 이후 회기로 넘겼습니다.',
  },
  {
    program: '작은만남',
    round: '2회기',
    ...
    evidence: '일지 PDF 확인',
    status: '내용확인',
    note: '2026.6.18.~19. 영화 퍼펙트 데이즈 감상, 기록지 작성과 소감 나눔을 실시했습니다. 발행대장 6.17. 표기는 확인이 필요합니다.',
  },
  {
    program: '작은만남',
    round: '3회기',
    ...
    evidence: '활동일지 PDF 확인',
    status: '내용확인',
    note: '2026.7.15.~16. 자유도서 선택, 인상 깊은 구절 기록과 나눔을 실시했습니다. 영화·독서는 이미 완료된 활동으로 남은 계획에서 제외합니다.',
  },
  {
    program: '하루 한 걸음',
    round: '1회기',
    ...
    evidence: '활동일지 PDF 확인',
    status: '내용확인',
    note: '2026.6.26.~28. 동네 도서관 방문과 사진기록을 실시했습니다. 조용한 공간 방문을 첫 외출 단계로 운영했습니다.',
  },
  {
    program: '하루 한 걸음',
    round: '2회기',
    ...
    evidence: '활동일지 PDF 확인',
    status: '내용확인',
    note: '2026.7.23.~24. 동네 카페 방문, 직접 주문과 사진기록을 실시했습니다. 방문에서 작은 대화로 난이도를 높였습니다.',
  },
  {
    program: '하루 한 걸음',
    round: '3회기',
