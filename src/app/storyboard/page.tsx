...
const PART_GUIDES: Record<number, GuideSection> = {
  ...
  10: {
    ...
    structure: [
      ...
      { pages: '3~5p — 이미 움직이는 흐름: 전국 선행사례와 정책 방향', content: '전국 과제: 종이팩 재활용률 14%, 연간 7만 톤 중 1만 톤만 재활용 / 선행 사례 1 — 초록열매 종이팩 컬렉티브(숲과나눔·사랑의열매): 전국 단위 아파트·마을·학교·카페 회수 모델 개발·확산(2023~) / 선행 사례 2 — 동대문종합사회복지관 체인지어스: 2022년 12월 시작, 서울공동모금회 3년 5억, 근로취약계층 일자리 연계 / 정책 흐름 — 기후에너지환경부 2026년 상반기 공동주택 수거함 의무화 추진(성남시 2억 5천만원 426단지 적용 중) / 서술 방향: 선행 사례들이 이 방향을 먼저 열었고 고산동은 지방 마을 단위에 적용 — 비교·우위 서술 금지' },
    ...
    cautions: [
      ...
      '선행 사례(초록열매·체인지어스)는 존중하는 톤으로 소개 — 비교·우위 서술 절대 금지',
      '성동구·수원시 등 출처 불명 사례 사용 금지. 초록열매·체인지어스·환경부만 사용',
    ],
  },
  11: {
